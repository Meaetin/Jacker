...
- **Centering:** All page content uses `max-w-*xl mx-auto` to center within the sidebar layout. Dashboard: `max-w-6xl`, Profile/Job Analysis: `max-w-4xl`, Detail/Edit: `max-w-2xl`.
